...
file = '/content/drive/My Drive/Colab Notebooks/TxtSteganography/LMBLSTM/data/train_tweet.txt'
word_all = []
...
def main(_):
    ...
    with tf.Graph().as_default(), tf.Session(config=config_tf) as session:
        ...
        start_words = []
        data = open('/content/drive/My Drive/Colab Notebooks/TxtSteganography/LMBLSTM/data/train_tweet.txt', 'r').readlines()
